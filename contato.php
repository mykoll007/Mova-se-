                        ...
                        if (!empty($_POST['nome']) && !empty($_POST['email']) && !empty($_POST['celular']) && !empty($_POST['assunto']) && !empty($_POST['mensagem'])) {
                            ...
                            if (mysqli_query($conexao, $sql)) {
                                ...
                                try {
                                    ...
                                    $mail->SMTPAuth = true;
                                    $mail->Username = 'elojobxcronos@gmail.com';
                                    $mail->Password = 'mhnhcbfdqwywvvbv';
                                    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
                                    $mail->Port = 587;

                                    $mail->setFrom('elojobxcronos@gmail.com', 'Mova-se');
                                    $mail->addAddress('elojobxcronos@gmail.com', 'Equipe Mova-se');
